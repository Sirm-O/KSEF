...
const ForcePasswordChangePage: React.FC = () => {
  const { user, theme, toggleTheme, changePassword } = useContext(AppContext);
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    if(user) {
        ...
        // On success, the AppContext will update the user state.
        // This will cause App.tsx to re-render, and the router will navigate away from this page automatically.
    } else {
